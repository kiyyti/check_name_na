import {z} from 'zod';
export const configSchema=z.object({ready:z.boolean(),message:z.string().optional(),levels:z.array(z.string()),room:z.string().optional(),course:z.string().optional(),lateTime:z.string().regex(/^\d{2}:\d{2}$/).optional(),absenceTime:z.string().regex(/^\d{2}:\d{2}$/).optional()});
